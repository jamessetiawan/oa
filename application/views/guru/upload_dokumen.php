<div class="callout callout-info">
  ...
  <p>Silahkan untuk mengunggah file Administrasi mengajar Anda.File yang diupload hanya (.doc .xls .docx .xlsx .zip .rar)</p>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <textarea class="textarea" readonly placeholder="Silahkan isi note perbaikan dokumen ..." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $GetDataDoc_read->note_doc ?></textarea>
                        </div>
